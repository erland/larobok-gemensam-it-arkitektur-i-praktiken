...
## Nuvarande läge
Projektet befinner sig i skrivfas. Bokspecifikation, kapitelplan, källpolicy, terminologi och innehålls-canon är etablerade, och kapitel 1–16 är skapade som första utkast. Det ursprungliga arkitekturmaterialet ligger som arbetsunderlag under `docs/underlag/gemensam-it-arkitektur/` och exporteras inte som boktext.
